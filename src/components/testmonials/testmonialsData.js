...
const data = [
  ...
  },
  {
    ...
    avatar: avt3,
    review:
      "As a user of the student internship portal developed by sai kumar, I am thoroughly impressed with its performance and stability. It’s rare to find software that is so intuitive and easy to use, yet powerful under the hood. The few times I've encountered issues, the updates provided by sai kumar were prompt and effectively resolved the problems. This level of support and dedication makes me feel valued as a customer and confident in the software I use every day.",
  },
];
